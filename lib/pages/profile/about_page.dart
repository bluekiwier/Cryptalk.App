        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text(
                '${AppConfig.appName} 是一款专注于“极致隐私”与“纯粹沟通”的加密聊天应用。我们通过先进的端到端加密技术，确保您的每一条消息、每一张图片、每一段语音都只有您和接收者可见。',
            ...
            _buildFeatureItem(
              ...
              title: '零知识存储',
              description: '我们不收集您的通讯录、地理位置或任何个人身份信息，真正做到“零知识”运营。',
            ),
            _buildFeatureItem(
              context: context,
              icon: Icons.shutter_speed_rounded,
              title: '极速体验',
              description: '采用自研加密传输协议，在保证全量加密的前提下，依然拥有毫秒级的即时通讯体验。',
            ),
