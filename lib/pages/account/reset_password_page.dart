...
class ResetPasswordPage extends StatefulWidget {
  ...
  const ResetPasswordPage({super.key, required this.account});
...
class _ResetPasswordPageState extends State<ResetPasswordPage> with TickerProviderStateMixin {
  ...
  Future<void> _resetPassword() async {
    ...
    final result = await _accountService.resetPassword(
      widget.account,
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(widget.account, style: const TextStyle(fontSize: 16, color: AppTheme.textPrimary)),
                ),
                ...
                TextFormField(
                  ...
                  decoration: _buildInputDecoration(hintText: '请输入验证码', prefixIcon: Icons.verified_user_rounded),
                  validator: (value) {
